...
const stats = [
  ...
  { value: '10K+',label: 'SKUs disponibles',    delay: '0.1s' },
        ...
        <div class="container nosotros-split-grid">
          ...
          <div class="reveal-right" style="display:flex;">
            <div class="glass-panel-premium" style="padding:clamp(30px,5vw,60px);border-radius:30px;width:100%;display:flex;flex-direction:column;justify-content:center;background:#fff;box-shadow:0 25px 50px -12px rgba(0,0,0,.08);border:none;">
              ...
              <p style="font-size:1.1rem;line-height:1.8;color:rgba(0,0,0,.7);margin-bottom:20px;">Nacimos con una idea sencilla: acercar productos de calidad profesional al alcance de todos los distribuidores del país.</p>
              <p style="font-size:1.1rem;line-height:1.8;color:rgba(0,0,0,.7);margin-bottom:20px;">Con el tiempo, esa idea se convirtió en una red sólida de aliados comerciales que confían en nuestro compromiso, rapidez y respaldo.</p>
              <p style="font-size:1.1rem;line-height:1.8;color:rgba(0,0,0,.7);">Hoy, Comercializadora Marvelsa es referente nacional por su capacidad de distribución, su servicio posventa y su portafolio de marcas líderes que marcan la diferencia en cada proyecto.</p>
            </div>
          </div>
        </div>
      </section>
